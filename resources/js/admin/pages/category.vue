        ...
        <div class="content">
			<div class="container-flud">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					<p class="_title0">Categories <Button @click="addModal = true" v-if="isWritePermitted" ><Icon type="md-add" />Add</Button></p>
						...
						<table class="_table">
							...
							<!-- <tr v-for="category in categories" :key="category.id" v-if="categories.length"> -->
								...
								<td>
									...
									<Button type="error" size="small" @click="showDeleteModal(category, i)" :loading="category.isDeleting" v-if="isDeletePermitted">Delete</Button>
